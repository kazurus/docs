/*!
 * ClipboardJS.js v2.0.4
 * https://zenorocha.github.io/ClipboardJS.js
 * 
...
var ClipboardJS = function (_Emitter) {
    ...
    _createClass(ClipboardJS, [{
        ...
        value: function onClick(e) {
            ...
            if (this.ClipboardJSAction) {
                this.ClipboardJSAction = null;
            }

            this.ClipboardJSAction = new _clipboardAction2.default({
        ...
        value: function destroy() {
            ...
            if (this.ClipboardJSAction) {
                this.ClipboardJSAction.destroy();
                this.ClipboardJSAction = null;
            }
        }
    }], [{
...
function getAttributeValue(suffix, element) {
    var attribute = 'data-ClipboardJS-' + suffix;
